...
def feval(x : npt.NDArray[np.float64]) -> np.float64:
    x = x.reshape(-1, 1)
    f : npt.NDArray[np.float64] = np.zeros(18, dtype = np.float64)
    f[0]  = x[0] ** 2 + x[1] ** 2 + x[0] * x[1] - 14 * x[0] - 16 * x[1] + (x[2] - 10) ** 2  \
          + 4 * (x[3] - 5) ** 2 + (x[4] - 3) ** 2 + 2 * (x[5] - 1) ** 2 + 5 * x[6] ** 2 \
          + 7 * (x[7] - 11) ** 2 + 2 * (x[8] - 10) ** 2 + (x[9] - 7) ** 2 + (x[10] - 9) ** 2 \
          + 10 * (x[11] - 1) ** 2 + 5 * (x[12] - 7) ** 2 + 4 * (x[13] - 14) ** 2  \
          + 27 * (x[14] - 1) ** 2 + x[15] ** 4 + (x[16] - 2) ** 2 + 13 * (x[17] - 2) ** 2 \
          + (x[18] - 3) ** 2 + x[19] ** 2 + 95
    ...
    f[5]  = f[0] + 10 * (4 * x[0] + 5 * x[1] - 3 * x[6] + 9 * x[7] - 105)
    f[6]  = f[0] + 10 * (10 * x[0] - 8 * x[1] - 17 * x[6] + 2 * x[7])
    f[7]  = f[0] + 10 * (-3 * x[0] + 6 * x[1] + 12 * (x[8] - 8) ** 2 - 7 * x[9])
    f[8]  = f[0] + 10 * (-8 * x[0] + 2 * x[1] + 5 * x[8] - 2 * x[9] - 12)
    f[9]  = f[0] + 10 * (x[0] + x[1] + 4 * x[10] - 21 * x[11])
    f[10] = f[0] + 10 * (x[0] ** 2 + 5 * x[10] - 8 * x[11] - 28)
    f[11] = f[0] + 10 * (4 * x[0] + 9 * x[1] + 5 * x[12] ** 2 - 9 * x[13] - 87)
    f[12] = f[0] + 10 * (3 * x[0] + 4 * x[1] + 3 * (x[12] - 6) ** 2 - 14 * x[13] - 10)
    f[13] = f[0] + 10 * (14 * x[0] ** 2 + 35 * x[14] - 79 * x[15] - 92)
    f[14] = f[0] + 10 * (15 * x[1] ** 2 + 11 * x[14] - 61 * x[15] - 54)
